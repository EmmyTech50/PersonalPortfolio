    ...
    >
      ...
      <Box flex="1" color="#000000" p={6}>
        ...
        <Text
          ...
          fontSize={['sm', 'sm', 'md']}
        >
          I'm a passionate frontend developer with a sharp eye for design and
          user experience. Specializing in building responsive, dynamic, and
          engaging interfaces. I combine creativity with the latest web
          technologies to deliver seamless user experiences. Whether working on
          complex web apps or sleek single-page applications, I'm committed to
          bringing ideas to life through clean, efficient code and intuitive UI
          design.
        </Text>
        <Button
          mt={2}
